      ...
      <div className="Skills-2">
        <div className="html">
          ...
          <ul>
            ...
            <li>컴퓨터공학</li>
            <li>
              데이터베이스, 알고리즘, 네트워크, 운영체제, 멀티미디어개론, 등
            </li>
          </ul>
        </div>
        <div className="html">
        ...
        <div className="html">
          ...
          <ul>
            ...
            <li>
              React.js, Vue.js의 지식이 되는 JavaScript의 기본기를 익히기 위한
              과목으로, VanillaJS (외부 라이브러리/프레임워크를 사용하지 않는
