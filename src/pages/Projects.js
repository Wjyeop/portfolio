      ...
      <div className="Projects-1">
        <div className="Hdc">
          <div className="div1">
            ...
            <span className="second">23.9~23.12</span>
          </div>
          <div className="div2">
            <ul>
        ...
        <div className="myDiary">
          <div className="div1">
            ...
            <span className="second">23.6~23.6</span>
          </div>
          <div className="div2">
            <ul>
        ...
        <div className="Tbems">
          <div className="div1">
            ...
            <span className="second">22.2~22.9</span>
          </div>
          <div className="div2">
            <ul>
              <li>건물 에너지 관리 시스템 웹 페이지</li>
              <li>
                건물 에너지 총 사용량을 불러와 시각화 하고 전월, 전년 평균과
                현재 평균 사용량과 비교하여 에너지 사용량 추이를 알 수 있습니다.
              </li>
              <li>
                단위 구역(사무실, 복도, 등)의 에너지 사용량을 조회 및 전원 버튼
                조작을 합니다.
              </li>
              <li>건물에 대한 다양한 정보들을 조회할 수 있습니다.</li>
              <li>
                프론트 : React, JavaScript, HTML, CSS, StyledComponent, Ajax,
                RestAPI, ApexCharts
              </li>
        ...
        <div className="Saffy">
          <div className="div1">
            ...
            <span className="second">22.12~23.1</span>
          </div>
          <div className="div2">
            <ul>
              <li>
                담당 역할 : 로그인 페이지(SNS로그인, 페이지 분기 처리), 마이
                페이지(개인정보 수정 및 등록) 구현
              </li>
        ...
        <div className="IbizSoft">
          ...
          <div className="div2">
            <ul>
              <li>
                담당 역할 : 대시 보드 페이지(데이터 테이블 표기 및 그래프 표기)
                및 권한 설정 페이지(개인 설정 수정 및 개인 정보 등록) 구현
              </li>
              <li>
                기술 스택 : Window, TypeScript, PHP, SCSS, Github, Figma,
                PostMan, Recoil ,Ajax
              </li>
            </ul>
            <img
              src="img/ibizsoft1.png"
              alt=""
              onClick={() => setShowIbiz((e) => !e)}
            />
          </div>
        </div>
      </div>
            ...
            >
              <SwiperSlide>
                <img
                  src="img/ibizsoft1.png"
                  alt=""
                  onClick={() => setShowIbiz(false)}
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="img/ibizsoft2.png"
                  alt=""
                  onClick={() => setShowIbiz(false)}
                />
              </SwiperSlide>
